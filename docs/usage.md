...
This downloads all the libraries Sentinel needs (pandas, scikit-learn, yfinance, etc.) and then installs Sentinel itself. It takes 1 to 3 minutes the first time.
